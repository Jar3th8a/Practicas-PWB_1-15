...
<template>
  <main class="page">
    <section class="hero card">
      ...
      <p>
        Proyecto integrador con Laravel + Vue: autenticacion, router, pinia, carrito, categorias y subida de imagenes.
      </p>
      <div class="hero-actions">
        <RouterLink class="btn" to="/catalogo">Ver catalogo</RouterLink>
