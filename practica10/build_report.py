...
ROOT = Path(r"C:\Users\alesh\practica1-autenticacion\practica10")
OUT = ROOT / "evidencias" / "Reporte_Practica_10_Testing_PHPUnit_Vitest.docx"
CAPTIONS = ROOT / "evidencias" / "capturas"

TITLE = "Practica 10\nTesting: Backend y Frontend"
SUBTITLE = "Pruebas automatizadas con PHPUnit y Vitest"
...
def add_title_page(doc):
    ...
    rows = [
        ...
        ("Practica", "10 - Testing automatizado"),
        ("Tecnologias", "PHPUnit, Vitest, Vue Test Utils, Laravel, Vue 3"),
        ("Fecha", DATE_TXT),
    ]
...
def main():
    ...
    add_bullet(doc, "Se crearon pruebas automatizadas para registro, login, listado, creacion y permisos sobre la API.")
    add_bullet(doc, "Se agregaron pruebas de frontend con Vitest y Vue Test Utils para componentes y llamadas a la API.")
    add_bullet(doc, "Se genero reporte de cobertura del frontend y se intento la cobertura PHP con phpdbg.")
    add_bullet(doc, "Se mantuvo una base de aplicacion funcional en Laravel y Vue para comprobar los tests en contexto real.")

    add_heading(doc, "3. Evidencias", level=1)
    evidence = [
        (1, "Pruebas backend", "practica10_01_backend_tests.png", "Se ejecuto la suite de PHPUnit y se confirmo que las pruebas de registro, login, CRUD y permisos pasan correctamente.", "Figura 1. Resumen de pruebas backend."),
        (2, "Cobertura PHP", "practica10_02_backend_coverage_warning.png", "Se intento generar cobertura con phpdbg y se registro la advertencia del entorno sin driver de coverage disponible.", "Figura 2. Intento de cobertura PHP en el entorno local."),
        (3, "Pruebas frontend", "practica10_03_frontend_tests.png", "Se ejecuto la suite de Vitest y Vue Test Utils para los componentes reutilizables creados en la practica.", "Figura 3. Resumen de pruebas frontend."),
        (4, "Cobertura Vitest", "practica10_04_frontend_coverage.png", "Se genero el reporte de cobertura del frontend y se confirmo un porcentaje superior al minimo solicitado.", "Figura 4. Resumen de cobertura de Vitest."),
        (5, "Cobertura HTML", "practica10_05_vitest_coverage_html.png", "Se abrio el reporte HTML de cobertura para revisar la tabla detallada por componente.", "Figura 5. Vista HTML del reporte de cobertura."),
    ]
    ...
    add_bullet(doc, "Se crearon pruebas para registro, login, listado, creacion y permisos sobre la API.")
    add_bullet(doc, "Se agregaron pruebas de frontend con Vitest y Vue Test Utils para componentes y llamadas a la API.")
    add_bullet(doc, "Se genero reporte de cobertura del frontend y se intento la cobertura PHP con phpdbg.")
    add_bullet(doc, "Validaciones ejecutadas: php artisan test, phpdbg -qrr artisan test --coverage --min=70 y npm run test:coverage.")
