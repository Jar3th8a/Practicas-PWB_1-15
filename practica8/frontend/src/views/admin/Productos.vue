...
<template>
  <div>
    <div class="row-between">
      ...
      <RouterLink v-can="'crear'" class="btn" to="/admin/nuevo">Nuevo producto</RouterLink>
    </div>
      ...
      <tbody>
        <tr v-for="producto in productos" :key="producto.id">
          ...
          <td class="admin-actions">
            ...
            <RouterLink v-can="'editar'" class="link" :to="`/admin/editar/${producto.id}`">Editar</RouterLink>
            <button v-can="'eliminar'" class="btn btn-danger" @click="borrar(producto.id)">Eliminar</button>
          </td>
        </tr>
      </tbody>
    </table>
