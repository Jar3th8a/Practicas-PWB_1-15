...
const FiltrosPanel = defineAsyncComponent(() => import('@/components/FiltrosPanel.vue'))
const PaginacionNav = defineAsyncComponent(() => import('@/components/PaginacionNav.vue'))
        ...
        <section class="catalog-results">
          ...
          <div v-else class="grid-products">
            <ProductoCard
              ...
              :key="producto.id"
              :producto="producto"
              :cantidad-en-carrito="carrito.cantidadDeProducto(producto.id)"
              @agregar-carrito="carrito.agregar"
            />
          </div>
